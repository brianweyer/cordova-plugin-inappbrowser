...
public class AuthenticationDialog {
    ...
    private void createDialog() {
        ...
        mUsernameView.setTextColor(Color.DKGRAY);
        ...
        mDialog = new AlertDialog.Builder(mContext,  android.R.style.Theme_Material_Light_Dialog_Alert)
                .setTitle(title)
        ...
        mDialog.setOnShowListener( new DialogInterface.OnShowListener() {
          ...
          public void onShow(DialogInterface arg0) {
            mDialog.getButton(AlertDialog.BUTTON_NEGATIVE).setTextColor(Color.parseColor("#42A7C6"));
            mDialog.getButton(AlertDialog.BUTTON_POSITIVE).setTextColor(Color.parseColor("#42A7C6"));
          }
        });
